...
lib.ssMetadata = [
		{name:"animate_atlas_1", frames: [[0,0,797,273]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.bartest();
	this.instance.setTransform(561.4,422.4);
...
p.nominalBounds = new cjs.Rectangle(1521.4,962.4,-163,-267);
// library properties:
lib.properties = {
